...
describe('routes/Product/SubscriptionCreate', () => {
  ...
  describe('errors', () => {
    ...
    it('reports declined card', async () => {
      ...
      await commonSetup();
      expect(
        screen.getByText(getDefaultErrorMessage['card-error'])
      ).toBeInTheDocument();
    });
    ...
    it('reports expired card', async () => {
      ...
      await commonSetup();
      expect(
        screen.getByText(getDefaultErrorMessage['expired-card-error'])
      ).toBeInTheDocument();
    });
    ...
    it('reports processing errors', async () => {
      ...
      await commonSetup();
      expect(
        screen.getByText(getDefaultErrorMessage['payment-error-1'])
      ).toBeInTheDocument();
    });
    ...
    it('reports stolen card error', async () => {
      ...
      await commonSetup();
      expect(
        screen.getByText(getDefaultErrorMessage['payment-error-2'])
      ).toBeInTheDocument();
    });
  });
});
